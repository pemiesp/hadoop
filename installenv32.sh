...
wget -c --header "Cookie: oraclelicense=accept-securebackup-cookie" http://download.oracle.com/otn-pub/java/jdk/8u181-b13/96a7b8442fe848ef90c96a2fad6ed6d1/jdk-8u181-linux-i586.tar.gz
sudo mkdir /opt/jdk
sudo tar -zxf jdk-8u181-linux-i586.tar.gz -C /opt/jdk
...
rm jdk-8u181-linux-i586.tar.gz
...
echo  "export PATH=$PATH:/opt/maven/apache-maven-3.5.4/bin:/home/$USER/gitviews/batchadoop/singlenodex:/home/$USER/gitviews/batchadoop/singlenode" | sudo tee --append /etc/profile.d/bigdata_env.sh
source /etc/profile.d/bigdata_env.sh
export PATH=$PATH:/opt/maven/apache-maven-3.5.4/bin:/home/$USER/gitviews/batchadoop/singlenodex:/home/$USER/gitviews/batchadoop/singlenode
#Disable ipv6
